...
<head>
 ...
 <link rel="icon" type="image/png" href="recursos/img/ejemplo.ico"/>
  ...
  <script src="js/formulario_tema.js"></script>
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Registre un nuevo genero</h3>
			 			</div>
			 			<div class="panel-body">
			    		<form method="post" id="registration_form" action="genero.php" role="form">
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			                 <input type="text" id="form_nombre" name="nombre" class="form-control input-sm" placeholder="Primer Apellido" required="">

...
<div class="container-fluid">
  <div class="row content">
	...
	<br><br>
	 ...
	 <h3>Gestión de peliculas</h3>
	 <br>
	  <div class="well"><a href="añadir_pelicula.php">Registre una nueva pelicula</div></a>
		<div class="well"><a href="tabla_peli.php">Peliculas en la base de datos</div></a>
		<br><br>
		<div class="alert alert-warning">
			<strong>Por favor!</strong> Antes de añadir una pelicula, añada el director, el genero y la productora. Gracias.
		</div>	
	</div>

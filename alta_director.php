...
<head>
  ...
  <script src="js/formulario_autor.js"></script>
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Registre un nuevo director</h3>
			 			</div>
			 			<div class="panel-body">
			    		<form method="post" id="registration_form" action="director.php" role="form">
			    			<div class="row">
